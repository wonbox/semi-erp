...
<body>
	<form action="ProductionUpdateContent.jsp" method="post">
		<%
					...
					<div class="jumbotron">
						<table class="table table-striped">
							...
							<tr>
								...
								<th align="center"><a
									href="ProductionUpdateContent.jsp?pno=<%=rs.getString("pno")%>"><%=rs.getString("pname")%></a></th>
