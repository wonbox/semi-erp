...
<body>
	<form
		action="ProductionUpdateProc.jsp?pno=<%=request.getParameter("pno")%>"
		method="post">
		<%
			productDao pDao = new productDao();
			productInfo pInfo = pDao.select(Integer.parseInt(request.getParameter("pno")), "H");
		%>
		...
		<div class="container">
			...
			<div class="row row-offcanvas row-offcanvas-right">
				<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar"
					role="navigation">
					<jsp:include page="/WEB-INF/view/inc/Production/Production/left.jsp"/>
					<!--/.well -->
				</div>
				<!--/span-->
					...
					<div class="jumbotron">
						<table class="table table-striped">
							...
							<tr>
								...
								<th align="center"><input type="text" name="pnum"
									value="<%=pInfo.getPnum()%>"></th>
								<th align="center"><input type="text" name="price"
									value="<%=pInfo.getPrice()%>"></th>
							</tr>
							<tr>
								<th></th>
								<th></th>
