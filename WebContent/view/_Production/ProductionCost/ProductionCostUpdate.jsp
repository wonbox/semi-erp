...
<body>
	<form action="ProductionCostUpdateContent.jsp" method="post">
		<%
			...
			<div class="row row-offcanvas row-offcanvas-right">
				<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar"
					...
					<div class="well sidebar-nav">
						<ul class="nav">
							<li><a href="ProductionCost.jsp"><h3>원가 관리</h3></a></li>
							<li><a href="ProductionCostUpdate.jsp">정보 수정</a></li>
						</ul>
					</div>
					<!--/.well -->
				</div>
					...
					<div class="jumbotron">
						<table class="table table-striped">
							...
							<tr>
								...
								%>
								<th><a
									href="ProductionCostUpdateContent.jsp?pno=<%=rs.getString("pno")%>"><%=rs.getString("price")%>원</a></th>
							</tr>
							<%
								}
								rs.close();
