...
<body>
	<form action="yearplanupdateProc.jsp?deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>" method="post">
				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="jumbotron" width="80">
						<table class="table table-striped" style="table-layout: fixed;">
							<tr>
								<th style="width: 100px;">계획 번호</th>
								<th style="width: 10px;">:</th>
								<th><div class="input-group input-group-sm">
										<input type="text" class="form-control" name="yid"
											placeholder="" value="">
									</div></th>
							</tr>
							<tr>
							...
							<tr>
								...
								<th>:</th>
								<th><div class="input-group input-group-sm">
										<input type="text" class="form-control" name="sellnum"
											placeholder="" value="">
									</div></th>
							</tr>
							<tr>
								...
								<th>:</th>
								<th><div class="input-group input-group-sm">
										<input type="text" class="form-control" name="sump"
											placeholder="" value="">
									</div></th>
							</tr>	
							<tr>
								...
								<th><button type="submit" name="save"
										class="btn btn-default" value="수정">수정</button></th>
							</tr>
						</table>
					</div>
					<div class="row"></div>
