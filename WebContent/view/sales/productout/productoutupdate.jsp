...
<body>
	<form action="productoutupdateProc.jsp" method="post">
				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="jumbotron" width="80">
						<table class="table table-striped" style="table-layout: fixed;">
							<tr>
								<th style="width: 100px;">출고 번호</th>
								<th style="width: 10px;">:</th>
								<th><div class="input-group input-group-sm">
										<input type="text" class="form-control" name="pout"
											placeholder="" value="">
									</div></th>
							</tr>							
							<tr>
								...
								<th>:</th>
								<th><div class="input-group input-group-sm">
										<input type="text" class="form-control" name="poutnum"
											placeholder="" value="">
									</div></th>
							</tr>		
