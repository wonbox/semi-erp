...
<%
	...
	String query1 = "SELECT * FROM yearsellplan  ORDER BY yid asc;";
	...
	<div class="container">
		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar"
				role="navigation">
					<jsp:include page="/WEB-INF/view/inc/sales/left.jsp"/>
				<!--/.well -->
			</div>
			<!--/span-->
			<div class="col-xs-12 col-sm-9">
				...
				<div class="jumbotron">
					 <table class="table table-striped">
						...
						<%
							while (rs.next()) {
								if (rs.getString("yid").equals("0")) {
									continue;
								}
						%>
						<tr>
							<th><%=rs.getString("yid")%></th>
							<th><%=rs.getString("pno")%></th>
							<th><%=rs.getString("sellnum")%></th>
							<th><%=rs.getString("sump")%></th>
							<th><%=rs.getString("month")%></th>
		...
		<div class="footer" align="center">Copyright(c) 2015 by mind.
			All pictures cannot be copied  permission.</div>
		<p></p>
