...
<body>
	<form action="ComponentOutUpdateContent.jsp?deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>" method="post">
		<%
			Class.forName("com.mysql.jdbc.Driver");
			Connection conn = DriverManager.getConnection("jdbc:mysql://mind.iptime.org:43306/test", "test1", "abcd1234");

			String query1 = "SELECT * FROM product where pdiv = 'H' ORDER BY pno desc;";
		...
		<div class="container">
			...
			<div class="row row-offcanvas row-offcanvas-right">
				<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar"
					role="navigation">
					<jsp:include page="/WEB-INF/view/inc/Purchase/productionmanage/left.jsp"/>
					<!--/.well -->
				</div>
				<!--/span-->
					...
					<div class="jumbotron">
						<table class="table table-striped">
							...
							<tr>
								...
								<th align="center"><a
									href="ComponentOutUpdateContent.jsp?pno=<%=rs.getString("pno")%>&deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>"><%=rs.getString("pname")%></a></th>
								<th align="center"><%=rs.getString("price")%></th>
