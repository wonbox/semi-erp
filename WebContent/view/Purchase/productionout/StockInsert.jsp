...
<body>
	<form action="StockInsertProc0.jsp?deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>" method="post">
		...
		<div class="container">
			...
			<div class="row row-offcanvas row-offcanvas-right">
				<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar"
					role="navigation">
					<jsp:include page="/WEB-INF/view/inc/Purchase/productionout/left.jsp"/>
					<!--/.well -->
				</div>
				<!--/span-->
						...
						<table class="table table-striped" style="table-layout: fixed;">
							...
							<tr>
								...
								<th><button type="submit" name="save"
										class="btn btn-default" value="출고">출고</button></th>
							</tr>
						</table>
					</div>
					<div class="row"></div>
