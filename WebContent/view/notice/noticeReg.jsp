...
<body>
	<form action="noticeRegProc.jsp?deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>" method="post">
		...
		<div class="container">
			...
			<div class="row row-offcanvas row-offcanvas-right">
				<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar"
					...
					<jsp:include page="/WEB-INF/view/inc/notice/left.jsp"/>
