				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="jumbotron">
						<table class="table table-striped">
							...
							%>
							<tr>
								<th align="center"><%=rs.getString("seq")%></th>
								<th align="center"><a
									href="noticeUpdateContent.jsp?seq=<%=rs.getString("seq")%>&deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>"><%=rs.getString("title")%></a></th>
								<th align="center"><%=rs.getString("regdate")%></th>
							</tr>
							<%
								}
								rs.close();
