...
<body>
	<form action="HumenUpdateContent.htm?deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>" method="post">
						...
						<table class="table table-striped">
							...
							<c:forEach var="n" items="${humens}">
								<tr>
									...
									<th>${n.emno}</th>
									<th>${n.dename}</th>
									<th><a href="HumenUpdateContent.htm?emno=${n.emno}">${n.emname}</a></th>
									<th>${n.emaddress}</th>
									<th>${n.emtel}</th>
									<th>${n.emposition}</th>
									<th>${n.emjoindate}</th>
