...
<body>
	<form action="DepartmentInsertProc.htm?deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>" method="post">
				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="jumbotron" width="80">
						<table class="table table-striped" style="table-layout: fixed;">
							...
							<tr>
								<th></th>
								<td><button type="submit" name="save"
										class="btn btn-default" value="등록">등록</button></td>
							</tr>
						</table>
					</div>
					<div class="row"></div>
