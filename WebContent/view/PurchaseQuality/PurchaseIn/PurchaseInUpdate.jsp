				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="jumbotron">
						<table class="table table-striped">
							...
							%>
							<tr>
								<th align="center"><%=rs.getString("p.pno")%></th>
								<th align="center"><a
									href="ComponentInUpdateContent.jsp?pno=<%=rs.getString("p.pno")%>&deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>"><%=rs.getString("p.pname")%></a></th>
								<th align="center"><%=rs.getString("p.insize")%></th>
								<th align="center"><%=rs.getString("p.indate")%></th>
								<th align="center"><%=rs.getString("s.sname")%></th>
							</tr>
							<%
								}
								rs.close();
