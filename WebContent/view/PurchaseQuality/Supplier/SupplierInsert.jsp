...
<body>
	<form action="SupplierInsertProc.jsp?deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>" method="post">
				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="jumbotron" width="80">
						<table class="table table-striped" style="table-layout: fixed;">
							<tr>
								<th style="width: 100px">거래처 코드</th>
							...
							<tr>
								...
								<th>:</th>
								<th><div class="input-group input-group-sm">
										<input type="text" class="form-control" name="ceotel"
											placeholder="" value="">
									</div></th>
							</tr>
