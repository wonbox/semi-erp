...
<body>
	<form action="SupplierUpdateContent.jsp?deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>" method="post">
		<%
					...
					<div class="jumbotron">
						<table class="table table-striped">
							...
							<tr>
								...
								<th align="center"><a
									href="SupplierUpdateContent.jsp?sno=<%=rs.getString("sno")%>&deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>"><%=rs.getString("sname")%></a></th>
