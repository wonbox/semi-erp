...
<body>
	...
	%>
	<form action="OrderPurchaseDeleteProc.jsp?deno=<%=request.getParameter("deno")%>&emno=<%=request.getParameter("emno")%>" method="post">
				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="jumbotron">
						<table class="table table-striped">
							...
							%>
							<tr>
								<th><input type="checkbox" name="ono"
									id="<%=rs.getString("ono")%>"
									value="<%=rs.getString("ono")%>" /><label
									for="<%=rs.getString("ono")%>"></label></th>
								<th><%=rs.getString("ono")%></th>
								<th><%=rs.getString("otitle")%></th>
