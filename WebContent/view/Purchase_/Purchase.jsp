		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar"
				...
				<div class="well sidebar-nav">
					<ul class="nav">
						<li><a href="Purchase.jsp"><h3>자재 관리</h3></a></li>
						<li><a href="./ComponentIn/ComponentIn.jsp">자재 수입</a></li>
						<li><a href="./ComponentOut/ComponentOut.jsp">자재 출고</a></li>
						<li><a href="./Supplier/Supplier.jsp">거래처 관리</a></li>
						<li><a href="./Stock/Stock.jsp">창고 관리</a></li>
					</ul>
				</div>
				<!--/.well -->
			</div>
