...
<%@page import="org.semierp.vo.productcompoutInfo"%>
...
<body>
	<form
		action="ComponentOutUpdateProc.jsp?pno=<%=request.getParameter("pno")%>"
		method="post">
		<%
			productcompoutDao pDao = new productcompoutDao();
			productcompoutInfo pInfo = pDao.select(Integer.parseInt(request.getParameter("pno")));
		%>
					...
					<div class="jumbotron">
						<table class="table table-striped">
							...
							<tr>
								...
								<th align="center"><input type="text" name="outsize"
									value="<%=pInfo.getOutsize()%>"></th>
								<th align="center"><input type="text" name="outdate"
									value="<%=pInfo.getOutdate()%>"></th>
							</tr>
							<tr>
								<th></th>
								<th></th>
